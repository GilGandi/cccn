        ...
        <div className="relative z-10 max-w-[900px] mx-auto px-6 sm:px-10 lg:px-16 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="font-body font-light text-[0.95rem] leading-[1.9] text-[#888480]">
              Sua contribuição sustenta o ministério, os cultos, os projetos sociais e a missão da Comunidade Cristã de Campos Novos.
            </p>
          </div>
          <div className="flex flex-col gap-5 p-8" style={{ border: '1px solid rgba(240,237,232,0.12)' }}>
            <div>
              ...
              <div className="font-display text-[1.2rem] text-[#f0ede8] break-all">18.702.714/0001-07</div>
