...
export default async function AdminDashboard() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="font-display text-[1.8rem] text-[#f0ede8] mb-1">Olá, {session.user?.name?.split(' ')[0]} 👋</h1>
        <p className="font-body text-[0.85rem] text-[#888480]">Bem-vindo ao painel administrativo da C.C.C.N</p>
      </div>
      ...
      <div className="p-5 rounded border border-[rgba(200,185,154,0.2)] bg-[rgba(200,185,154,0.04)]">
        <p className="font-body text-[0.82rem] text-[#c8b99a] mb-1 font-medium tracking-wide uppercase text-[0.65rem]">Primeiro acesso?</p>
