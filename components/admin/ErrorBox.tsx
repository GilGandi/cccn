      ...
      {expandido && (
        <div className="border-t border-red-500/20 px-4 pb-4 pt-3">
          <div className="flex items-center justify-between mb-2">
            <span className="font-body text-[0.58rem] tracking-widest uppercase text-red-400/60">Detalhes do erro</span>
            <button
              type="button"
              onClick={copiar}
            ...
            >
              {copiado ? (
                ...
                <>
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
                  Copiar
                </>
              )}
            </button>
