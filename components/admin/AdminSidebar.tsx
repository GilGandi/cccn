...
const links: NavLink[] = [
  ...
  { href: '/admin/eventos-inscricao', label: 'Eventos', icon: (
        ...
        {links.filter(l => {
          ...
          return (
            <Link key={l.href} href={l.href} //onClick={onNav}
              onClick={(e) => {
                console.log('CLICOU NO LINK', l.href);
                // Se você estiver no mobile e quiser fechar o menu, pode chamar onNav aqui
                // if (onNav) onNav();
              }}
